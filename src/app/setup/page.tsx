      ...
      >
        ...
        <div className="flex items-start justify-between gap-4 mt-3">
          <div className="flex-1">
            ...
            <p className="text-sm text-text-secondary mb-1">Powered by Google Gemini 2.5 Flash. No API key needed — just works.</p>
            {/* Quality warning */}
            <div className="flex items-start gap-2 rounded-lg bg-warning/10 border border-warning/20 px-3 py-2 mb-3">
              <svg className="h-4 w-4 text-warning shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20"><path fillRule="evenodd" d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z" clipRule="evenodd" /></svg>
              <p className="text-xs text-warning">This is a free model and results may not always be high quality. For better results, connect your own premium API key below.</p>
            </div>
            <p className="text-xs text-text-muted mb-4">50 requests per day per person. Need more? Connect your own key below.</p>
